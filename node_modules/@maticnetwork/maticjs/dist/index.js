...
var Matic = /** @class */ (function (_super) {
    ...
    function Matic(options) {
        ...
        _this.depositManager = new DepositManager_1.default(options.depositManager, _this.web3Client, _this.registry);
            ...
            return __generator(this, function (_b) {
                switch (_b.label) {
                    ...
                    case 4:
                        ...
                        return [4 /*yield*/, this._fillOptions(options, {}, web3Object)];
                    case 5:
                        _options = _b.sent();
                        if (options.encodeAbi) {
                            return [2 /*return*/, _options];
                        }
                        return [2 /*return*/, this.web3Client.wrapWeb3Promise(web3Object.eth.sendTransaction(_options), _options)];
                }
            });
        });
    };
    ...
    Matic.prototype.transferWithSignature = function (sig, sellOrder, buyOrder, to, options) {
        return __awaiter(this, void 0, void 0, function () {
            var web3Util, data, txObj, _options;
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0:
                        if (!options.from) {
                        ...
                        return [4 /*yield*/, this._fillOptions(options, txObj, this.web3Client.getMaticWeb3())];
                    case 1:
                        _options = _a.sent();
                        return [2 /*return*/, this.web3Client.send(txObj, _options)];
                }
            });
        });
    };
